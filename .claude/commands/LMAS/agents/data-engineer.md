...
- **@architect (Architect):** Receives system architecture requirements from, provides database design to
...
- **@architect (Architect)** - Provides system architecture

---
---
*LMAS Agent - Synced from .lmas-core/development/agents/data-engineer.md*
