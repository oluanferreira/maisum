...
activation-instructions:
  ...
  - STEP 3: |
      ...
      # FALLBACK: If native greeting fails, run: node .lmas-core/development/scripts/unified-activation-pipeline.js analyst
...
- **@pm (Trinity):** Provides research and analysis to support PRD creation
- **@po (Keymaker):** Provides market insights and competitive analysis
...
- **@pm (Trinity)** - Primary consumer of research
- **@po (Keymaker)** - May request market insights
