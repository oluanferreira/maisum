...
activation-instructions:
  ...
  - STEP 3: |
      ...
      # FALLBACK: If native greeting fails, run: node .lmas-core/development/scripts/unified-activation-pipeline.js architect
...
- **@github-devops (Operator):** For git push operations and PR creation
...
---
---
*LMAS Agent - Synced from .lmas-core/development/agents/architect.md*
